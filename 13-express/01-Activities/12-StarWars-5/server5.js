...
app.post("/api/new", function(req, res) {
  //req.body is used when making post requests to save a thing to a server.
    //req.params is used when you want to extract something from the url in a get request
