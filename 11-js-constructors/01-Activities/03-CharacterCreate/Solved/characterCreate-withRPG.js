...
warrior.swingHammer = function (target) {
  target.hitpoints -= this.strength * 2;
};
...
rogue.specialAttack(warrior);
warrior.specialAttack(warrior);
// rogue.swingHammer(warrior);
warrior.swingHammer(rogue);
warrior.printStats();
rogue.printStats();
// warrior.isAlive();
//
